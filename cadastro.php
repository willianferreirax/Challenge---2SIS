...
<body>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                        ...
                        <?php if (!isset($_SESSION['user']) && !isset($_SESSION['dev'])) { ?>
							<li>
								<a href="cadastro.php" class="btn btn-danger">
									<svg class="bi d-block mx-auto mb-1" width="24" height="24">
	...
	<main class="container-fluid d-flex justify-content-center align-items-center mt-5">
		<div class="containerLogin shadow">
			...
			<h2 class="title d-flex justify-content-center">Cadastro</h2>
			...
			<div class="form mb-5">
				...
				<input type="text" name="name" id="name" class="input" autocomplete="off" placeholder="Nome">

				<label for="email">Email</label>
				<input type="email" name="email" id="email" class="input" autocomplete="off" placeholder="Email">
				...
				<input type="password" name="password2" id="password2" class="input" autocomplete="off" placeholder="Repetir senha">
